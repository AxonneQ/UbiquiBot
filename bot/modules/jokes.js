const apisrc = [
    ...
    { name: 'prog', protocol: 'https', address: "https://sv443.net/jokeapi/v2/joke/Programming", extract: ['joke', 'setup', 'delivery'] },

    //Dark jokes, (need to implement toggle per server basis, turn off by default)
    { name: 'dark', protocol: 'https', address: "https://sv443.net/jokeapi/v2/joke/Dark", extract: ['joke', 'setup', 'delivery'] }
];
